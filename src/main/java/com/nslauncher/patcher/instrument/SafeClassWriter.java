package com.nslauncher.patcher.instrument;
...
public class SafeClassWriter extends ClassWriter {
    ...
    public SafeClassWriter(ClassReader cr, ClassLoader loader, final int flags, Config config) {
        super(cr, flags);
    ...
    private ClassReader typeInfo(final String type) throws IOException {
        ...
        final byte[] bytes = JarHelper.getBytes(resource, config.getJar());
        if (bytes == null) {
